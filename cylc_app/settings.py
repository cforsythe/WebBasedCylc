"""
Django settings for cylc_app project.
...
SECRET_KEY = 'qrt=b=berv=rk5k8r83qyww*#7b-f)1p+8%t2bjqzg0ee5$d*c'
...
WSGI_APPLICATION = 'cylc_app.wsgi.application'
